var selectTop3 = document.querySelector(".btn-success");
var allGraphs = document.querySelector(".btn-warning");
...
window.onload = function () {
    ...
    selectTop3.addEventListener('click',GraphsForThree);
    allGraphs.addEventListener('click', myFunction);